...
Copy og.py ..\textract-pipeline\lambda\textractor\python\og.

Copy helper.py ..\omnom\lambda\helper\python\helper.py
Copy datastore.py ..\omnom\lambda\helper\python\datastore.py
Copy s3proc.py ..\omnom\lambda\s3processor\lambda_function.py
Copy s3batchproc.py ..\omnom\lambda\s3batchprocessor\lambda_function.py
Copy docproc.py ..\omnom\lambda\documentprocessor\lambda_function.py
Copy syncproc.py ..\omnom\lambda\syncprocessor\lambda_function.py
Copy asyncproc.py ..\omnom\lambda\asyncprocessor\lambda_function.py
Copy jobresultsproc.py ..\omnom\lambda\jobresultprocessor\lambda_function.py
Copy trp.py ..\omnom\lambda\textractor\python\trp.py
Copy og.py ..\omnom\lambda\textractor\python\og.py
